...
;; vc编译设置(2005)
(setenv "VSINSTALLDIR" "C:\\Program Files\\Microsoft Visual Studio 8")
(setenv "VCINSTALLDIR" "C:\\Program Files\\Microsoft Visual Studio 8\\VC")
(setenv "FrameworkDir" "C:\\WINDOWS\\Microsoft.NET\\Framework")
(setenv "FrameworkVersion" "v2.0.50727")
(setenv "FrameworkSDKDir" "C:\\Program Files\\Microsoft Visual Studio 8\\SDK\\v2.0")
(setenv "CommonDevEnvDir" "C:\\Program Files\\Microsoft Visual Studio 8\\Common7")
(setenv "DevEnvDir"
...
(custom-set-variables
 ...
 '(ecb-layout-name "left-methods-symboldefs")
 ...
 '(semantic-c-dependency-system-include-path
   (quote
	("C:/Program Files/Microsoft Visual Studio 8/VC/include" "C:/Program Files/Microsoft Visual Studio 8/VC/PlatformSDK/Include" "C:/Program Files/Microsoft Visual Studio 8/VC/atlmfc/include" "C:/Program Files/Microsoft Visual Studio 8/SDK/v2.0/include")))
...
;stl(解析vector map等)
(setq stl-base-dir "c:/Program Files/Microsoft Visual Studio 8/VC/include")
...
(defun create-proj()
  ...
  (setq proj (ede-cpp-root-project "code" :file root-file
								   ;; (setq proj (ede-cpp-root-project "code" :file "./projects.sln"
...
;; (dolist (hook '(c-mode-common-hook helm-update-hook gtags-select-mode-hook semantic-symref-results-mode-hook cscope-list-entry-hook))
;;   (add-hook hook
;; 			(lambda()
;; 			  (remove-dos-eol)
;; 			  )))
